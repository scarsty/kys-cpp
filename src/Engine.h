...
enum BP_Align { BP_ALIGN_LEFT, BP_ALIGN_MIDDLE, BP_ALIGN_RIGHT };
...
public:
  ...
  void getWindowMaxSize(int &w, int &h) {
  ...
  void updateYUVTexture(BP_Texture *t, uint8_t *data0, int size0,
                        uint8_t *data1, int size1, uint8_t *data2, int size2);
  ...
  void setTextureAlphaMod(BP_Texture *t, uint8_t alpha) {
  ...
  void renderCopy(BP_Texture *t, int x, int y, int w = 0, int h = 0,
                  double angle = 0, int inPresent = 0);
  void renderCopy(BP_Texture *t, BP_Rect *rect0, BP_Rect *rect1,
                  double angle = 0, int inPresent = 0);
  void destroy();
  bool isFullScreen();
  ...
  BP_Texture *transBitmapToTexture(const uint8_t *src, uint32_t color, int w,
                                   int h, int stride);
  ...
  void setTextureBlendMode(BP_Texture *t) {
...
public:
  ...
  static double getTicks() {
    return 1e-6 * std::chrono::time_point_cast<std::chrono::nanoseconds>(
...
public:
  ...
  BP_Texture *createTextTexture(const std::string &fontname,
                                const std::string &text, int size, BP_Color c);
...
enum BP_EventType {
  ...
  // BP_CONTROLLERTOUCHPADDOWN = SDL_CONTROLLERTOUCHPADDOWN,
  // BP_CONTROLLERTOUCHPADMOTION = SDL_CONTROLLERTOUCHPADMOTION,
  // BP_CONTROLLERTOUCHPADUP = SDL_CONTROLLERTOUCHPADUP,
  // BP_CONTROLLERSENSORUPDATE = SDL_CONTROLLERSENSORUPDATE,
