		...
		if (r->CoolDown == 0)
		{
			if (r->UsingMagic == nullptr)
			{
				...
				else
				{
					//其他ai可以使用所有武学
					// 仅当内力满的时候选高伤害武功
					// 否则选低伤害，如果没有第二个武功，则内力满时武功威力增加? 待定
