...
void NewSave::initDBFieldInfo()
{
    ...
    if (role_.size() == 0)
    {
        ...
        role_ = {
            ...
            // Interleaved: skill + power per slot, grouped by star
            BIND_FIELD_INT("一星武功1", MagicID[0]),
            BIND_FIELD_INT("一星威力1", MagicPower[0]),
            BIND_FIELD_INT("一星武功2", MagicID[1]),
            BIND_FIELD_INT("一星威力2", MagicPower[1]),
            BIND_FIELD_INT("二星武功1", MagicID[2]),
            BIND_FIELD_INT("二星威力1", MagicPower[2]),
            BIND_FIELD_INT("二星武功2", MagicID[3]),
            BIND_FIELD_INT("二星威力2", MagicPower[3]),
            BIND_FIELD_INT("三星武功1", MagicID[4]),
            BIND_FIELD_INT("三星威力1", MagicPower[4]),
            BIND_FIELD_INT("三星武功2", MagicID[5]),
            BIND_FIELD_INT("三星威力2", MagicPower[5]),
        };
    }
    if (item_.size() == 0)
    {
    ...
    if (magic_.size() == 0)
    {
        ...
        magic_ = {
            ...
            BIND_FIELD_INT("移动范围", SelectDistance),
            BIND_FIELD_INT("杀伤范围", AttackDistance),
            BIND_FIELD_INT("加内力", AddMP),
            BIND_FIELD_INT("杀伤内力", HurtMP),
        };
    }
    if (shop_.size() == 0)
    {
