--function oldevent_854()
    ...
    if instruct_31(400,6,0) ==false then    --  31(1F):判断银子是否够400是则跳转到:Label1
        instruct_1(3379,236,0);   --  1(1):[???]说: 钱不够啊，这可不行，我这*已经是成本价了，怎么说你*也要让我糊口啊。
        instruct_0();   --  0(0)::空语句(清屏)
        do return; end
    end    --:Label1

    instruct_32(174,-400);   --  32(20):物品[银两]+[-400]
    instruct_1(3380,236,0);   --  1(1):[???]说: 好，一手交钱，一手交货。
    instruct_0();   --  0(0)::空语句(清屏)
    instruct_2(46,1);   --  2(2):得到物品[绿波香露刀][1]
    instruct_0();   --  0(0)::空语句(清屏)
